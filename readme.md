...
引用で指定した画像の左右反転画像を作成するpython３で動作するプログラムです。
...
### 3.1.実行例
- コマンドラインフォーマット
`pythom3 flip.py <input_image_path> <output_image_path>`
- 利用例
`pythom3 flip.py inpput.jpg output.jpg`
